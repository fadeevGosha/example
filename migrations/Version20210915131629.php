 ...
 */
final class Version20210915131629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assessment_session_question (id INT AUTO_INCREMENT NOT NULL, session_id INT NOT NULL, question INT NOT NULL, answer_date_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_answered TINYINT(1) NOT NULL, INDEX IDX_22B2369F613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE assessment_session_question_answer (id INT AUTO_INCREMENT NOT NULL, question_session_id INT NOT NULL, value LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE assessment_stage_status (id INT AUTO_INCREMENT NOT NULL, assessment_id INT DEFAULT NULL, use_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, INDEX IDX_5FE21EC5DD3DD5F1 (assessment_id), INDEX IDX_5FE21EC5C1A7BCDD (use_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE assessment_stage_status ADD CONSTRAINT FK_5FE21EC5DD3DD5F1 FOREIGN KEY (assessment_id) REFERENCES assessment (id)');
        $this->addSql('ALTER TABLE assessment_stage_status ADD CONSTRAINT FK_5FE21EC5C1A7BCDD FOREIGN KEY (use_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assessment_stage_status DROP FOREIGN KEY FK_5FE21EC5DD3DD5F1');
        ...
        $this->addSql('DROP TABLE assessment_session_question_answer');
        $this->addSql('DROP TABLE assessment_stage_status');
